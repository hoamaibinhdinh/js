/*! AJAX Search Widget for Blogger V2 hoamaixunau*/ ! function(e, t) {
    function r(e, t) {
        function r(e) {
   ...
   function w(e) {
    ...
    var L = e.q2o,
        ...
        R = {
            ...
            chunk: 50,
            text: {
                title: "Kết quả tìm kiếm cho từ khóa: <em>%s%</em>",
                loading: "Đang tìm kiếm&hellip;",
                previous: "Trước",
                next: "Sau",
                empty: "Không có kết quả nào được tìm thấy <em>%s%</em>.",
                end: "Không còn kết quả nào <em>%s%</em>."
            },
            query: {
                alt: "json",
                orderby: "updated"
